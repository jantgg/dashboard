...
import "./tareasUrgentes.css";
import { AiOutlineWarning } from "react-icons/ai";
import { FaRegTrashAlt } from "react-icons/fa";
import { BsCheckCircle } from "react-icons/bs";

function TareasUrgentes() {
  ...
  return (
    <section>
      <h2 className="tittletareasTU">Tareas urgentes</h2>
      <ul className="listatareasTU">
        {tareasUrgentes.map((tarea) => (
          <li key={tarea._id} className="tareaTU">
            {/* <AiOutlineWarning className="warningTU" /> */}
            <span className="tareanombreTU"> {tarea.titulo}</span>
            <div className="buttonstareaTU">
              {" "}
              <button
              className="checkTU"
              ...
              <button className="trashTU" onClick={() => deleteTarea(tarea._id)}>
                <FaRegTrashAlt  />
              </button>
            </div>
          </li>
